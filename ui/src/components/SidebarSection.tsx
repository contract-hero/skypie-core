...
// Key changed from skypie.bookmarks.collapsed when sections were generalized;
// the old value is intentionally dropped rather than migrated.
function storageKey(id: string): string {
  return `skypie.section.${id}.collapsed`;
}
...
export interface SidebarSectionProps {
  /** Stable id — the data-section value; forms the storage key `skypie.section.<id>.collapsed`. */
  id: string;
  title: string;
