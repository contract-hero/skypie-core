...
export default function Sidebar({
  ...
  // no folder/file picker, no full-tree Files drawer, no drag-out. What it
  // shows is what arrived: the Received drawer.
  if (isIos) {
    return (
      <div className="sidebar">
        <div className="sidebar-header" data-tauri-drag-region>
          <span className="sidebar-header-title">Sky Pie</span>
          {settingsButton}
        </div>
