...
// pops up regardless of whether Settings is open (a `skypie://pair` link can
// arrive at any time, and the fingerprint step happens on BOTH screens the
// moment either side reaches it). Two faces, mutually exclusive:
...
import type { RemotePendingPair } from "../ipc";
